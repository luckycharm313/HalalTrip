...
import styles from './Styles/ActivitySavedItemStyle'
...
class ActivitySavedItem extends Component {
  _onActivityDetail = () => {
    this.props.nav.navigate('ActivitySavedDetailScreen', {activityId : this.props.data.id});
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivitySavedItem)